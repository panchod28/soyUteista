...
class routesRedirect {
  ...
  public static function rootDir(Type $var = null)
  {
  ...
  {
    header("Location:".self::getCurrentNavigation().self::rootDir()."/ingresarNotificacion.php");
  }

  public static function redirectGetData()
  {
    header("Location:".self::getCurrentNavigation().self::rootDir()."/listarNotificacion.php");
  }
}
?>
