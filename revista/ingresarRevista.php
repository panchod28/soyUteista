                           ...
                           <form method="POST" action="validaciones/crearRevista.php" enctype="multipart/form-data">
                              <div class="card-body">
                                 <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="edicion" placeholder="Ingrese la edicion" required autocomplete="off">
                                 </div>
                                 <div class="form-group">
                                    <label for="">Fecha</label>
                                    <input type="month" class="form-control" name="fecha" required autocomplete="off">
                                 </div>
                                 <div class="form-group">
